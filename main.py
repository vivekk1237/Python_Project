...
def rps():
    ...
    def player_choice(player_input):
        global player_score, computer_score,player_count,computer_count
    ...
    def ask_quit():
        ...
        if tkMessageBox.askokcancel("Quit", "You want to quit now?"):
            ...
            player_score=0
            computer_score=0
            winner_label.config(text="Let's Again Start the Game...")
            player_score_label.config(text = 'Your Score : ' + str(player_score))
            computer_score_label.config(text='Your Score : ' + str(computer_score))
    ...
    root.mainloop()
    return render_template('Level1.html',playerscore=player_count)
